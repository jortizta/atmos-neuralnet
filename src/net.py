...
class TurbNetG(nn.Module):
    def __init__(self, channelExponent=6, dropout=0.):
        ...
        self.layer1.add_module('layer1_conv', nn.Conv2d(5, channels, kernel_size=[4,1], stride=2, padding=1, bias=True))
        ...
        self.dlayer1.add_module('dlayer1_tconv', nn.ConvTranspose2d(channels*2, 2, [4,1], 2, 1, bias=True))
